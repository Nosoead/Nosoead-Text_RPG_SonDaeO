        ...
        public void ChooseNum()
        {
            switch (choiceNum)
            {
                case 0:
                    ...
                    break;
                case 1:
                    choiceNum = StatusWindow();
                    break;
                case 2:
                    choiceNum = InventoryWindow();
                    break;
                case 3:
                    choiceNum = ShopWindow();
                    break;
            }
        }

        public int EnterVillage()
        {
            Console.Clear();
            do
            {
